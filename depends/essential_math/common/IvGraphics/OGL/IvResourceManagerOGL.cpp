...
//-------------------------------------------------------------------------------
IvVertexShader* 
IvResourceManagerOGL::CreateVertexShaderFromFile( const char* filename, const char* functionname )
{
...
//-------------------------------------------------------------------------------
IvFragmentShader* 
IvResourceManagerOGL::CreateFragmentShaderFromFile( const char* filename, const char* functionname )
{
