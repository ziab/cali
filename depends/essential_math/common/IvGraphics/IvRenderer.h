...
typedef void(*tOnResizeCbk)(unsigned int width, unsigned int height);
...
public:
	...
	virtual void RegisterOnResizeCbk(tOnResizeCbk callback) = 0;
	...
	virtual void SetConstantBuffer(IvConstantBuffer* constantBuffer, unsigned int index) = 0;
	virtual void UpdateConstantBuffer(IvConstantBuffer* constantBuffer) = 0;

	virtual void SetRenderTarget(IvRenderTexture* targetTexture, bool noDepthStencil = false) = 0;
	virtual void SetRenderTargets(const std::vector<IvRenderTexture*>& targetTextures, bool noDepthStencil = false) = 0;
	virtual void ReleaseRenderTarget() = 0;
	virtual void ClearRenderTarget(IvRenderTexture* targetTexture, IvClearBuffer buffer, const IvVector4& color) = 0;
