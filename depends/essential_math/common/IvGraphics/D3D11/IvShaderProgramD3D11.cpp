...
IvShaderProgramD3D11::GetUniform(char const* name)
{
    ...
    {
        uniform = new IvUniformD3D11((int)desc.mTextureSlot, desc.mSamplerSlot, this, desc.mStage);
    } 
    else
    {
        uniform = new IvUniformD3D11(desc.mType, desc.mCount, desc.mOffset, constantTable, this, desc.mStage);
    }
