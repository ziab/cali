...
public:
    ...
    virtual IvVertexShader* CreateVertexShaderFromFile( const char* filename, const char* functionname ) = 0;
    ...
    virtual IvFragmentShader* CreateFragmentShaderFromFile( const char* filename, const char* functionname ) = 0;
	...
	virtual IvRenderTexture* CreateRenderTexture(unsigned int width, unsigned int height, IvTextureFormat format) = 0;
	virtual IvRenderTexture* CreateRenderTexture(unsigned int width, unsigned int height, unsigned int depth, IvTextureFormat format) = 0;
	virtual void Destroy(IvRenderTexture* tex) = 0;

	virtual IvConstantBuffer* CreateConstantBuffer(size_t ) = 0;
