...
public:
    ...
    IvVertexShader* CreateVertexShaderFromFile(const char* filename, const char* functionname) final;
    ...
    IvFragmentShader* CreateFragmentShaderFromFile(const char* filename, const char* functionname) final;
	...
	virtual IvRenderTexture* CreateRenderTexture(unsigned int width, unsigned int height, IvTextureFormat format) final;
	virtual IvRenderTexture* CreateRenderTexture(unsigned int width, unsigned int height, unsigned int depth, IvTextureFormat format) final;
	virtual void Destroy(IvRenderTexture* tex) final;

	virtual IvConstantBuffer* CreateConstantBuffer(size_t size) final;
